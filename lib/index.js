...
(function() {
  ...
  JFN.renderHTML = function(schema, name, data, options) {
    var classname, e, html, i, id, inputtype, item, k, len1, p, properties, ref1, value, values, was;
    if (schema == null) {
    ...
    if (schema['enum'] && !schema.hidden) {
      ...
      while (e = schema['enum'][i]) {
        schema.value = e;
        if (data && data === e) {
          schema.attributes = this.template.types.string_enum_value_selected;
        }
      ...
      switch (type) {
        ...
        case 'boolean':
          ...
          if (type === 'boolean' && data) {
            ...
            html += ' value="' + this.htmlEncode(data.toString()) + '"';
          }
          if (schema.readonly) {
            html += ' readonly';
          }
